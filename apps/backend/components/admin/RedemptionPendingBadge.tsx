...
import { useRedemptionPending } from "./RedemptionPendingProvider";

export function RedemptionPendingBadge({ variant = "sidebar" }: { variant?: "sidebar" | "dot" }) {
  const { pendingCount } = useRedemptionPending();
