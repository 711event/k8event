INSERT INTO groups (id, name, slug) VALUES ('a0000000-0000-0000-0000-000000000005', 'KG', 'kg') ON CONFLICT (id) DO NOTHING;

INSERT INTO activities (type, name, slug, description, banner_url, rules, is_active, is_visible, sort_order, settings, group_id)
SELECT type, name, slug || '-kg', description, banner_url, rules, is_active, is_visible, sort_order, settings, 'a0000000-0000-0000-0000-000000000005'
...
SELECT name, description, image_url, cost, stock, is_active, 'a0000000-0000-0000-0000-000000000005'
...
SELECT 'a0000000-0000-0000-0000-000000000005', message_retention_days, media_retention_days, archive_closed_threads_after_days, warn_after_minutes, critical_after_minutes
